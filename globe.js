...
DAT.Globe = function(container, colorFn) {
  ...
  function init() {
    ...
    renderer.setClearColorHex(0x110030, 0.0);
  ...
  function createPoints() {
    ...
    this.uniforms['textureData'].texture = THREE.ImageUtils.loadTexture(imgDir+'worldData_Max' + '.jpg');
  ...
  function addPoint(x,y,z,u,v, subgeo) {
    ...
    point.scale.set(pointScale, pointScale, 10);
